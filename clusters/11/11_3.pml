...
color salmon, chain C & 4CY2_A_C_11_3 & resi 3+4+5+6+7+8
color slate, chain C & 4CY2_A_C_11_3 & resi 1+2+9

color salmon, chain C & 4CY5_A_C_11_3 & resi 2+3+4+5+6+7
color slate, chain C & 4CY5_A_C_11_3 & resi 1+8

color salmon, chain B & 4Y7R_A_B_11_3 & resi 2+3+4+5+6+7
color slate, chain B & 4Y7R_A_B_11_3 & resi 1+8

color salmon, chain D & 2XL2_B_D_11_3 & resi 3+4+5+6+7+8
color slate, chain D & 2XL2_B_D_11_3 & resi 1+2+9+10
